...
class GoldColorsGroup(bpy.types.Operator):
    ...
    def make_group(self):
        ...
        if bpy.app.version < (4, 0, 0):
            ...
            gold_cg.interface.new_socket(name="Gold", in_out='OUTPUT')
            gold_cg.interface.new_socket(name="PBM Gold", in_out='OUTPUT')
            gold_cg.interface.new_socket(name="White Gold", in_out='OUTPUT')
            gold_cg.interface.new_socket(name="Chaos Gold", in_out='OUTPUT')
            gold_cg.interface.new_socket(name="Crayola Gold", in_out='OUTPUT')
            gold_cg.interface.new_socket(name="Vegas Gold", in_out='OUTPUT')
            gold_cg.interface.new_socket(name="Old Gold", in_out='OUTPUT')
            gold_cg.interface.new_socket(name="Satin Sheen Gold", in_out='OUTPUT')
            gold_cg.interface.new_socket(name="Pirate Gold", in_out='OUTPUT')
            gold_cg.interface.new_socket(name="Golden Yellow", in_out='OUTPUT')
            gold_cg.interface.new_socket(name="Golden Gold", in_out='OUTPUT')
            gold_cg.interface.new_socket(name="Golden Poppy", in_out='OUTPUT')
            gold_cg.interface.new_socket(name="Harvest Gold", in_out='OUTPUT')
