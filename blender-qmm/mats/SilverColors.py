...
class SilverColorsGroup(bpy.types.Operator):
    ...
    def make_group(self):
        ...
        if bpy.app.version < (4, 0, 0):
            ...
            silver_cg.interface.new_socket(name="Silver", in_out='OUTPUT')
            silver_cg.interface.new_socket(name="Pale Silver", in_out='OUTPUT')
            silver_cg.interface.new_socket(name="PBM Silver", in_out='OUTPUT')
            silver_cg.interface.new_socket(name="Crayola Silver", in_out='OUTPUT')
            silver_cg.interface.new_socket(name="Silver Pink", in_out='OUTPUT')
            silver_cg.interface.new_socket(name="Basic Silver", in_out='OUTPUT')
            silver_cg.interface.new_socket(name="Silver Sand", in_out='OUTPUT')
            silver_cg.interface.new_socket(name="Silver Chalice", in_out='OUTPUT')
            silver_cg.interface.new_socket(name="Old Silver", in_out='OUTPUT')
            silver_cg.interface.new_socket(name="Roman Silver", in_out='OUTPUT')
            silver_cg.interface.new_socket(name="Sonic Silver", in_out='OUTPUT')
