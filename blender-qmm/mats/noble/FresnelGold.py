...
class QMMGoldFresnel(bpy.types.Operator):
    ...
    def make_shader(self):
        ...
        m_glossy = self.make_node(
            nodes, "ShaderNodeBsdfGlossy", -400, -200, (0.658375, 0.42869, 0.0382044, 1)
        )

        #glossyshader2
        m_glossy2 = self.make_node(
            nodes, "ShaderNodeBsdfGlossy", -600, 0, (0.658375, 0.42869, 0.0382044, 1)
        )

        #diffuseshader
        m_diffuse = self.make_node(
            nodes, "ShaderNodeBsdfDiffuse", -600, 200, (0.658375, 0.42869, 0.0382044, 1)
        )
